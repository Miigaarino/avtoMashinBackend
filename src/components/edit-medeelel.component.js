...
export default class EditMedeelel extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios
      .get("http://localhost:5000/medeelluud/" + this.props.match.params.id)
      .then((response) => {
        this.setState({
          carDugaar: response.data.carDugaar,
          uildverlegch: response.data.uildverlegch,
          model: response.data.model,
          zasvarUilchilgee: response.data.zasvarUilchilgee,
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        "http://localhost:5000/medeelluud/update" + this.props.match.params.id,
        medeelel
      )
  ...
  render() {
    return (
      <div>
        <h3>Машины мэдээлэл засварлах</h3>
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            <input
              type="submit"
              value="Машины мэдээлэл засварлах"
